                    ...
                    @endif
                        <form method="post" action="{{ route('company.update',[$company->id]) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="descriptions" type="text" class="form-control @error('descriptions') is-invalid @enderror" name="descriptions" value="{{ $company->descriptions }}" required autocomplete="descriptions" autofocus>
